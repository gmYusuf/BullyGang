...
namespace HmsPlugin
{
    ...
    {
        public string scanInfo, remoteEndpointId = "Device2", transmittingMessage;
        public string myNameStr, mEndpointName = "Device", mFileServiceId = "com.bullygang.huawei";
        ...
        public void InitiateConnection(string endpointId, ScanEndpointInfo scanEndpointInfo, IConnectCallBack connectCallBack)
        {
            if (scanEndpointInfo.Name.Equals(scanInfo))
            {
                ...
                Nearby.DiscoveryEngine.RequestConnect(endpointId, myNameStr,   connectCallBack);
            }
        }
